...
public class EscidocJapaneseAnalyzer extends Analyzer {
    ...
    public TokenStream tokenStream(final String fieldName, final Reader reader) {
        ...
        try {
            ...
            while ((whitespaceToken = whitespaceTokens.next()) != null) {
                if (tokenBuffer.length() > 0) {
                    tokenBuffer.append(" ");
                }
                tokenBuffer.append(
                        whitespaceToken.termBuffer(), 0, whitespaceToken.termLength());
            }
        ...
        JapaneseAnalyzer analyzer = 
            new JapaneseAnalyzer(Constants.PATH_TO_JAPANESE_ANALYZER_CONFIG);
